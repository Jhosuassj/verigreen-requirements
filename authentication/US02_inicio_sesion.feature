Feature: Inicio de sesión
  ...
  Scenario: Inicio de sesión fallido por campos vacíos
    When el usuario deja el campo de correo electrónico o contraseña vacío
    And hace clic en "Iniciar Sesión"
    Then el sistema bloquea el intento de inicio de sesión
    And muestra el mensaje: "Debe ingresar su correo electrónico y contraseña para continuar."
